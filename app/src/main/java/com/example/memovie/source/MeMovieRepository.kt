...
class MeMovieRepository private constructor(private val remoteDataSource: RemoteDataSource,
    ...
    companion object{
        ...
        private var instance : MeMovieRepository? = null

        fun getInstance(remoteData : RemoteDataSource , localData : LocalDataSource , appExecutors : AppExecutors) : MeMovieRepository =
                instance ?: synchronized(this) {
                    instance ?: MeMovieRepository(remoteData , localData, appExecutors )
                }
    }
